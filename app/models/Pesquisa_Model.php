...
class Pesquisa_Model extends Model{
    ...
    public function PesquisaDenunciaContar($tabela, $campo, $informacao){ //conta quantidade de registro da consulta
        if(isset($informacao) && empty($informacao)){
