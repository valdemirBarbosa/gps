...
class DenunciaController extends Controller{
    ...
    //Não alterar mais este método. Já está funcionando corretamente
       ...
       public function Salvar(){
         ...
         echo "<br>Id do denunciante: <br>".$id_denunciante;
         ...
         if($id_denuncia != NULL){
/*                echo "<pre>";
                    $arr = array($id_denuncia, $denuncia, $id_denunciante, $tipo_documento, $numero_documento, $denunciados, $data_entrada, $observacao, $doc_anexo);
                    print_r($arr);
                echo "<pre>";
                exit;
  */              
